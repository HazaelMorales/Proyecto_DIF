...
public class ListaCasosPsicologia extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent a1 = new Intent(ListaCasosPsicologia.this,area_psicologia.class);
        startActivity(a1);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_casos_psicologia);
        ...
        regresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(ListaCasosPsicologia.this, area_psicologia.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void enviarDatos(String a){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://checolin00p2.000webhostapp.com/DIF/dif_php/mostrarCasos.php", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    editor.commit();
                    Intent i2 = new Intent(ListaCasosPsicologia.this, vercasos_area_psicologia.class);
                    finish();
                    startActivity(i2);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ListaCasosPsicologia.this,error.toString(),Toast.LENGTH_LONG).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ListaCasosPsicologia.this);
