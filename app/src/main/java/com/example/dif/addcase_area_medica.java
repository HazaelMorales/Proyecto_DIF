...
public class addcase_area_medica extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onBackPressed() {
        Intent i2 = new Intent(addcase_area_medica.this,area_medica.class);
        startActivity(i2);
        finish();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addcase_area_medica);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.registrarcaso:
                insertar_caso();
                Intent i = new Intent(addcase_area_medica.this,area_medica.class);
                startActivity(i);
                finish();
                break;
            case R.id.fapertura:
    ...
    private void insertar_caso() {
        ...
        if (fechapertura.isEmpty()) {
            ...
            StringRequest request = new StringRequest(Request.Method.POST, "https://checolin00p2.000webhostapp.com/DIF/dif_php/ingresar_caso.php", new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    if (response.equalsIgnoreCase("Datos Insertados")) {
                        Toast.makeText(addcase_area_medica.this, "Datos Ingresados Correctamente", Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(addcase_area_medica.this, response, Toast.LENGTH_LONG).show();
                    }
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(addcase_area_medica.this, "Datos subidos incorrectamente", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
            }) {
                @Override
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(addcase_area_medica.this);
