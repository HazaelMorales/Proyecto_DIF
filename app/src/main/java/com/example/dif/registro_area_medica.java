...
public class registro_area_medica extends AppCompatActivity implements View.OnClickListener {
...
//                Toast.makeText(registrobeneficiario.this,clicker+"",Toast.LENGTH_LONG).show();
    ...
    private void insertar_beneficiarios() {
        ...
        if (nombrebene.isEmpty()) {
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(registro_area_medica.this);
