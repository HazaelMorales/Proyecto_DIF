...
public class registro_trabajo_social extends AppCompatActivity implements View.OnClickListener{
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        Intent i = new Intent(registro_trabajo_social.this,area_trabajosocial.class);
                        startActivity(i);
        ...
        if (nombrebene.isEmpty()) {
            ...
            StringRequest request = new StringRequest(Request.Method.POST, "https://checolin00p2.000webhostapp.com/DIF/dif_php/ingresar_beneficiario.php", new Response.Listener<String>() {
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(registro_trabajo_social.this, "Datos subidos incorrectamente", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
            }) {
                @Override
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(registro_trabajo_social.this);
