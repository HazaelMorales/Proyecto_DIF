...
public class addcase_area_trabajosocial extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onBackPressed() {
        Intent i2 = new Intent(addcase_area_trabajosocial.this, registro_trabajo_social.class);
        startActivity(i2);
        finish();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addcase_area_trabajosocial);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.registrarcaso:
                insertar_caso();
                Intent i = new Intent(addcase_area_trabajosocial.this, estudio_socioeconomico.class);
                startActivity(i);
                break;
            case R.id.fapertura:
...
//                Toast.makeText(casos.this,clicker+"",Toast.LENGTH_LONG).show();
    ...
    private void insertar_caso() {
        ...
        if (fechapertura.isEmpty()) {
            ...
            StringRequest request = new StringRequest(Request.Method.POST, "https://checolin00p2.000webhostapp.com/DIF/dif_php/ingresar_caso.php", new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    if (response.equalsIgnoreCase("Datos Insertados")) {
                        Toast.makeText(addcase_area_trabajosocial.this, "Datos Ingresados Correctamente", Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(addcase_area_trabajosocial.this, response, Toast.LENGTH_LONG).show();
                    }
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(addcase_area_trabajosocial.this, "Datos subidos incorrectamente", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
            }) {
                @Override
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(addcase_area_trabajosocial.this);
