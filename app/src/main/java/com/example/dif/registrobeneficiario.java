...
public class registrobeneficiario extends AppCompatActivity implements View.OnClickListener{
        ...
        if (nombrebene.isEmpty()) {
            ...
            StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.0.4/dif_php/ingresar_beneficiario.php", new Response.Listener<String>() {
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(registrobeneficiario.this, "Datos subidos incorrectamente", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
            }) {
                @Override
