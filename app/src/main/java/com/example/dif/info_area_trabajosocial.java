...
public class info_area_trabajosocial extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_area_trabajosocial);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.aceptar:
                Intent i = new Intent(info_area_trabajosocial.this,area_trabajosocial.class);
                startActivity(i);
                finish();
                break;
            case R.id.addnotes:
    ...
    public void onBackPressed() {
        Intent i2 = new Intent(info_area_trabajosocial.this,area_trabajosocial.class);
        startActivity(i2);
        finish();
    }
