...
public class seguimiento_psicologia extends AppCompatActivity implements  View.OnClickListener {
    ...
    public void onBackPressed() {
        Intent a1 = new Intent(seguimiento_psicologia.this,area_psicologia.class);
        startActivity(a1);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.submit:
                Intent i = new Intent(seguimiento_psicologia.this,area_psicologia.class);
                startActivity(i);
                finish();
                break;
        }
    ...
    private void enviarDatos(String a){
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "https://checolin00p2.000webhostapp.com/DIF/dif_php/mostrarDatosBeneficiarios.php", new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(seguimiento_psicologia.this,error.toString(),Toast.LENGTH_LONG).show();
            }
        }) {
            @Override
